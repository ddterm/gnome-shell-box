source "qemu" "debiantesting" {
  ...
  disk_discard = "unmap"
  http_content = {
    "/debian-preseed.cfg" = templatefile("${path.root}/debian-preseed.cfg", { path = path, hostname = "debiantesting" })
  }
  ssh_timeout = "1h"
  ssh_username = "root"
...
build {
  ...
  post-processors {
    ...
    post-processor "vagrant-registry" {
      box_tag = "gnome-shell-box/debiantesting"
